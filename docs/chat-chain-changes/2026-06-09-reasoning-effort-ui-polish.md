...
impact: Keeps the existing per-session reasoning effort override for DiTing CLI chats, hides the selector for Coding Agent sessions, and prevents Coding Agent run payloads from carrying the unsupported reasoning_effort override.
---

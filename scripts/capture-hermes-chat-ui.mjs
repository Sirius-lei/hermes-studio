...
const url = "http://127.0.0.1:8649/#/hermes/chat"
const screenshotPath = "/private/tmp/hermes-chat-ui-after-login.png"
const prompt = process.env.HERMES_CHAT_PROMPT || "帮我查询一下张三的涉案信息"
const waitAfterSendMs = Number(process.env.HERMES_CHAT_WAIT_MS || 2500)
const expandWorkflow = process.env.HERMES_EXPAND_WORKFLOW === "1"

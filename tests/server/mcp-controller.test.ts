...
vi.mock('../../packages/server/src/services/DiTing/agent-bridge/client', () => ({
...
describe('MCP Controller', () => {
  ...
  describe('listServers', () => {
    it('returns servers list from bridge', async () => {
      ...
      const { listServers } = await import('../../packages/server/src/controllers/DiTing/mcp')
      const ctx = createCtx()
  ...
  describe('addServer', () => {
    it('sends name and config to bridge', async () => {
      ...
      const { addServer } = await import('../../packages/server/src/controllers/DiTing/mcp')
  ...
  describe('updateServer', () => {
    it('sends name from params and config to bridge', async () => {
      ...
      const { updateServer } = await import('../../packages/server/src/controllers/DiTing/mcp')
      const ctx = createCtx({
        params: { name: 'github' },
  ...
  describe('removeServer', () => {
    it('sends name to bridge', async () => {
      ...
      const { removeServer } = await import('../../packages/server/src/controllers/DiTing/mcp')
  ...
  describe('testServer', () => {
    it('returns tool list from bridge', async () => {
      ...
      const { testServer } = await import('../../packages/server/src/controllers/DiTing/mcp')
      const ctx = createCtx({ params: { name: 'github' } })
  ...
  describe('listTools', () => {
    it('returns tools without server filter', async () => {
      ...
      const { listTools } = await import('../../packages/server/src/controllers/DiTing/mcp')
  ...
  describe('reloadMcp', () => {
    it('reloads all servers when no filter', async () => {
      ...
      const { reloadMcp } = await import('../../packages/server/src/controllers/DiTing/mcp')
      const ctx = createCtx({ query: {} })
      await reloadMcp(ctx)

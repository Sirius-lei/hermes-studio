...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``diting logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # DiTing only initiates compaction in "diting" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping DiTing preflight compression for codex app-server "
                "(mode=%s); DiTing will not start thread compaction here.",

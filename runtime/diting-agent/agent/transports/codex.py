...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around DiTing's web-provider config and
        ...
        # native search engine for xAI sessions instead of DiTing's
        # configured web provider (Tavily/etc.), and those results bypass
        # DiTing's tool-trace / citation plumbing (they arrive baked into the

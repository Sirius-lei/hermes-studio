...
(3 SDK retries x 3 DiTing retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_diting_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".diting")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, DiTing, ...) behind one endpoint.  A 429 can mean either:

"""Vertex AI (Google Cloud) adapter for DiTing Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows DiTing to use Gemini models via Google Cloud with
...
# who installed plain `diting-agent` and only later selected a Gemini model.
try:

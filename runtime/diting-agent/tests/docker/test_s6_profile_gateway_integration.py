...
The unit tests in tests/diting_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned diting-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/diting")
from diting_cli.service_manager import S6ServiceManager

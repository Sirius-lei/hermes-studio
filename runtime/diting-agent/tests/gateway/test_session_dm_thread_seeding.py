...
def store(tmp_path, monkeypatch):
    ...
    ~/.diting/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at diting_state import time, before pytest's DiTing_HOME monkeypatch
    fires — the autouse fixture's DiTing_HOME override doesn't help here.)
    """
    import diting_state

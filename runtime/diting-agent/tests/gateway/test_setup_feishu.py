"""Tests for _setup_feishu() in diting_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("diting_cli.config.save_env_value", side_effect=mock_save), \
         patch("diting_cli.config.get_env_value", side_effect=mock_get), \
         patch("diting_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("diting_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("diting_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("diting_cli.cli_output.print_header"), \
         patch("diting_cli.cli_output.print_info"), \
         patch("diting_cli.cli_output.print_success"), \
         patch("diting_cli.cli_output.print_warning"), \
         patch("diting_cli.cli_output.print_error"), \

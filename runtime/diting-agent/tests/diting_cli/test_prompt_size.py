"""Tests for the ``diting prompt-size`` diagnostic (issue #34667)."""
...
from diting_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(diting_home, memory_text="", user_text=""):
    mem_dir = diting_home / "memories"
...
def _seed_skill(diting_home, name, description):
    skill_dir = diting_home / "skills" / "demo" / name

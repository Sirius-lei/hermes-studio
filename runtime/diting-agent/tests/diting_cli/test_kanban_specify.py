"""Tests for the specifier module + `diting kanban specify` CLI surface.
...
from diting_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `diting kanban …` argparse surface directly."""

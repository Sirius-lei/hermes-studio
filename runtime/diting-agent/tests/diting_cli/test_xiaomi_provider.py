...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from diting_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in DiTing_OVERLAYS
        overlay = DiTing_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify diting doctor recognizes Xiaomi env vars."""

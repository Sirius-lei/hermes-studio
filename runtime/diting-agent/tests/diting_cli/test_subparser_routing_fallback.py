...
The main() function in diting_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `diting -c model`
...
def _build_parser():
    """Build a minimal replica of the diting top-level parser."""

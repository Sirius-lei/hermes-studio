"""Tests for the interactive session browser (`diting sessions browse`).
...
from diting_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """diting sessions browse should be parseable."""

"""Session <-> workspace grouping key (diting_state.workspace_key).

The key is what `diting sessions list --workspace` groups/filters on. It is a
...
from diting_state import workspace_key

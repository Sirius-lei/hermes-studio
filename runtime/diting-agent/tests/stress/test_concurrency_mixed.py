...
def worker_loop(worker_id: int, diting_home: str, result_file: str) -> None:
...
def reclaimer_loop(diting_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="diting_mixed_stress_")
    print(f"DiTing_HOME = {home}")

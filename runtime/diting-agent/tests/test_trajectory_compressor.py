...
def test_import_loads_env_from_diting_home(tmp_path, monkeypatch):
    home = tmp_path / ".diting"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-diting-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-diting-home"

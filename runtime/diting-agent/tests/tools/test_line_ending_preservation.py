...
@pytest.fixture
def diting_home(monkeypatch, tmp_path):
    """Isolate DiTing_HOME so the tests don't pollute the real config.
...
class TestPatchCRLFPreservation:
    def test_patch_on_crlf_file_stays_pure_crlf(self, diting_home, tmp_path):
    ...
    def test_patch_on_lf_file_stays_lf(self, diting_home, tmp_path):
    ...
    def test_patch_multiline_replacement_on_crlf(self, diting_home, tmp_path):
...
class TestWriteFileCRLFPreservation:
    ...
    def test_new_file_written_as_is(self, diting_home, tmp_path):
    ...
    def test_overwrite_lf_file_stays_lf(self, diting_home, tmp_path):

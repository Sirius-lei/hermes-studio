...
thinking phase.  DiTing's default cloud-stream stale detector
(``DiTing_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``DiTing_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the

...
def test_diting_meta_tolerates_non_dict():
    assert learning_graph._diting_meta({"metadata": "junk"}) == {}
    assert learning_graph._diting_meta({"metadata": {"diting": "junk"}}) == {}
    assert learning_graph._diting_meta({"metadata": {"diting": {"category": "x"}}}) == {"category": "x"}

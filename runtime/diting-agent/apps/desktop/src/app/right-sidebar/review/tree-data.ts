import type { DiTingReviewFile } from '@/global'
...
export function buildReviewFlatList(files: DiTingReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: DiTingReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')

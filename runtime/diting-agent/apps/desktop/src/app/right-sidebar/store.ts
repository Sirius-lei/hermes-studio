...
const TAKEOVER_KEY = 'diting.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which DiTing can't clear via the API — the user
 *  sees exactly what runs instead of DiTing silently deleting their creds. */

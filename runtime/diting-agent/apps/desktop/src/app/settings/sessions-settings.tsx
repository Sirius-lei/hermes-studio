...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/diting'
...
// / Program Files), which buried any files DiTing wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.DiTingDesktop` is
    ...
    const settings = window.DiTingDesktop?.settings

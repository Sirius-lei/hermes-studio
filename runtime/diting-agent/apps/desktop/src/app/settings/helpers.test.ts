...
describe('settings helpers', () => {
  ...
  it('reads and writes nested config paths', () => {
    const config: DiTingConfigRecord = { display: { theme: 'mono' } }
  ...
  it('rejects prototype-polluting config paths', () => {
    const config: DiTingConfigRecord = {}
  ...
  describe('providerGroup', () => {
    ...
    it('prefers the longest matching prefix so CN/regional buckets win', () => {
      ...
      // DiTing_QWEN_ shares the DiTing_ stem with other integrations.
      expect(providerGroup('DiTing_QWEN_BASE_URL')).toBe('DashScope (Qwen)')

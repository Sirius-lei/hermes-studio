...
import type { DiTingConfigRecord, ToolsetInfo } from '@/types/diting'
...
export function getNested(obj: DiTingConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: DiTingConfigRecord, path: string, value: unknown): DiTingConfigRecord {
...
function personalityOptions(config: DiTingConfigRecord): string[] {

...
import { getDiTingConfigRecord, listAllProfileSessions } from '@/diting'
...
// DiTing session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          },
          {
            icon: Download,
            id: 'cc-update-diting',
            keywords: ['update', 'upgrade', 'diting', 'version', 'system', 'restart'],
            label: cc.updateDiTing,

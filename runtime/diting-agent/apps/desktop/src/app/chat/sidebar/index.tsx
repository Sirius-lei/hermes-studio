...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/diting'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('diting:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('diting:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask DiTing to

...
import type { ProjectInfo, SessionInfo } from '@/diting'
 ...
 * repo shows its branches/worktrees even when they have no DiTing sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: DiTingGitWorktree[]
): SidebarSessionGroup[] {

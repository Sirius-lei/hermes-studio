...
const FOCUS_EVENT = 'diting:composer-focus'
const INSERT_EVENT = 'diting:composer-insert'
const INSERT_REFS_EVENT = 'diting:composer-insert-refs'
const SUBMIT_EVENT = 'diting:composer-submit'
const VOICE_TOGGLE_EVENT = 'diting:composer-voice-toggle'

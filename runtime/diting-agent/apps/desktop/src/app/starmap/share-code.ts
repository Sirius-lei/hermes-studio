...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/diting'
...
const VERSION = 3
const PREFIX = 'HML' // "DiTing Memory Loadout" — namespaces our codes like WoW's leading bytes.

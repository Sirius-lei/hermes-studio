...
import type { DiTingGitWorktree, DiTingRepoStatus } from '@/global'
...
export const $repoStatus = atom<DiTingRepoStatus | null>(null)
...
export const $repoWorktrees = atom<DiTingGitWorktree[]>([])

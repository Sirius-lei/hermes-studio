...
export interface PetInfo {
  ...
  // the DiTing "run" activity state uses the in-place running row).
 ...
 * DiTing_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'diting.desktop.pet-roam.v1'

...
const desktopWindow = window as unknown as { ditingDesktop?: Window['ditingDesktop'] }
const initialDiTingDesktop = desktopWindow.DiTingDesktop

function installDesktopBridge(partial: Partial<Window['ditingDesktop']> = {}) {
  desktopWindow.DiTingDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['ditingDesktop']
}
...
afterEach(() => {
  ...
  if (initialDiTingDesktop) {
    desktopWindow.DiTingDesktop = initialDiTingDesktop
  } else {
    delete desktopWindow.DiTingDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['ditingDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['ditingDesktop']['openExternal'] })

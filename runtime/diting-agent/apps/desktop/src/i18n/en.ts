...
export const en: Translations = {
  ...
  boot: {
    ready: 'DiTing Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading DiTing settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingDiTingDesktop: 'Starting DiTing Desktop…'
    },
    errors: {
      backgroundExited: 'DiTing background process exited.',
      backgroundExitedDuringStartup: 'DiTing background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your DiTing backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateDiTing: 'Update DiTing',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting DiTing Desktop.',
    ...
    native: {
      ...
      inputBody: 'DiTing is waiting for your response.',
      turnDoneTitle: 'DiTing finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to DiTing defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while DiTing is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'DiTing asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while DiTing was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let DiTing follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what DiTing is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen DiTing, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'DiTing checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading DiTing configuration...',
    ...
    gateway: {
      ...
      intro:
        'DiTing Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running DiTing backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset DiTing_DESKTOP_REMOTE_URL and DiTing_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private DiTing backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote DiTing backend.',
      remoteAuthHint:
        'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'DiTing Cloud',
      cloudDesc: 'Sign in once to DiTing Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'DiTing Cloud',
      cloudSignIn: 'Sign in to DiTing Cloud',
      cloudSignedIn: 'Signed in to DiTing Cloud',
      cloudNeedsSignIn: 'Sign in to DiTing Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your DiTing Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'DiTing Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of DiTing Cloud',
      cloudSignedOutMessage: 'Cleared the DiTing Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /diting.',
      ...
      restartingMessage: 'DiTing Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · DiTing ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. DiTing runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via diting curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As DiTing builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart DiTing to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update DiTing to generate pets.',
      backgroundHint: 'You can close this — DiTing will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure DiTing desktop' },
    ...
    ditingActiveSessions: (version, count) => `DiTing ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@diting:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent DiTing environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. DiTing will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the DiTing backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from DiTing. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting DiTing...',
    placeholderReconnecting: 'Reconnecting to DiTing…',
    ...
    attachUrlDesc: 'DiTing will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask DiTing to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating DiTing…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting DiTing…',
    ...
    unsupportedMessage: 'This version of DiTing can’t update itself from inside the app.',
    ...
    manualBody: 'You installed DiTing from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'DiTing will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the DiTing desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The DiTing updater takes over in its own window and reopens DiTing automatically when it’s done. Please don’t reopen DiTing yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. DiTing reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then DiTing reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'DiTing needs a one-time install',
    ...
    settingUpTitle: 'Setting up DiTing Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another DiTing CLI or desktop instance is running. Stop any running DiTing instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with DiTing Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'DiTing is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting DiTing…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run DiTing',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point DiTing at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — DiTing connects automatically',
    ...
    authorizeThere: 'Authorize DiTing there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize DiTing there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `DiTing Desktop v${version}`,
      ...
      gatewayTitle: 'DiTing inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. DiTing will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'DiTing is restarting...',
      askRestart: 'Ask DiTing to restart the server',
      lookingRestart: taskId => `DiTing is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'DiTing is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `DiTing finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'DiTing could not restart the server.',
      stillWorking:
        'DiTing is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'DiTing is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'DiTing gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.diting/config.yaml). DiTing won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'DiTing needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'DiTing needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart DiTing Desktop to use Save Image.',
    restartToSaveImages: 'Restart DiTing Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `diting gateway` running?'
    }
  },

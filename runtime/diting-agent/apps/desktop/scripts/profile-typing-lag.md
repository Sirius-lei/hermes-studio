...
cd apps/desktop
XCURSOR_SIZE=24 DiTing_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/diting-typing
# → /tmp/diting-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/diting-typing.before.heapsnapshot
# → /tmp/diting-typing.after.heapsnapshot
```

...
// even though a fresh shell — and the DiTing CLI — sees it immediately. The
// desktop's DiTing_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\diting. Reading
...
//       DiTing_HOME    REG_SZ    F:\DiTing\data
//

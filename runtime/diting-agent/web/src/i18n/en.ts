...
export const en: Translations = {
  ...
  status: {
    ...
    updateDiTingConfirmMessage:
      "This runs diting update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateDiTingConfirmNow: "Update now",
    updateDiTingConfirmTitle: "Update DiTing?",
    updatingDiTing: "Updating DiTing…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update DiTing plugins (`diting plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.diting/plugins/?",
    removeHint: "Only user-installed plugins under ~/.diting/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.diting/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that DiTing doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "DiTing Achievements",
      subtitle:
        "Collectible DiTing badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning DiTing session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run DiTing more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once DiTing sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "DiTing is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in DiTing Agent ☤",
    },
  },

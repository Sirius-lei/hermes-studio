...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateDiTing: string;
    updateDiTingConfirmMessage?: string;
    updateDiTingConfirmNow?: string;
    updateDiTingConfirmTitle?: string;
    updatingDiTing: string;
  ...
  // ── Achievements plugin (plugins/diting-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;

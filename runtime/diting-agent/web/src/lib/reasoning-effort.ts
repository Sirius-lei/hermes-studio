 ...
 *
 * Values mirror diting_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the DiTing default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (DiTing' default when unset). */

 ...
 *
 * Plugins call window.__DiTing_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__DiTing_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__DiTing_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__DiTing_PLUGIN_SDK__ = {
    ...
    // window.__DiTing_SESSION_TOKEN__ directly.
    authedFetch,

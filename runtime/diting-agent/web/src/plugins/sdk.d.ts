/**
 * DiTing Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__DiTing_PLUGIN_SDK__`` and
 * ``window.__DiTing_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__DiTing_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``DiTingPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@diting/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__DiTing_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__DiTing_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__DiTing_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface DiTingPluginSDK {
...
declare global {
  interface Window {
    __DiTing_PLUGIN_SDK__?: DiTingPluginSDK;
    __DiTing_PLUGINS__?: PluginRegistry;
  }
}

...
const STORAGE_KEY = "diting-dashboard-theme";
...
const FONT_STORAGE_KEY = "diting-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `diting_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "diting-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-diting-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-diting-theme-font", "true");

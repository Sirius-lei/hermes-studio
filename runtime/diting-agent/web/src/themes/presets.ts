 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `diting_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "DiTing Teal",
  description: "Classic dark teal — the canonical DiTing look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "DiTing Teal (Large)",
  description: "DiTing Teal with bigger fonts and roomier spacing",

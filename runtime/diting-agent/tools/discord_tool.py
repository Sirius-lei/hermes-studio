...
Only included in the diting-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "DiTing-Agent (https://github.com/NousResearch/diting-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_diting_home() / "cache" / "discord_capabilities.json"

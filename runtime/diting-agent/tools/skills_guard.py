...
Trust levels:
  - builtin:   Ships with DiTing. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.diting/\.env|\~/\.diting/\.env',
     "diting_env_access", "critical", "exfiltration",
     "directly references DiTing secrets file"),
    ...
    (r'\.diting/config\.yaml|\.diting/SOUL\.md',
     "diting_config_mod", "critical", "persistence",
     "references DiTing configuration files directly"),
...
# scan. `.skillignore` is the DiTing-native name; `.clawhubignore` is honored

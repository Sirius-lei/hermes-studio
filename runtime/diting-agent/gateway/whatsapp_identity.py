...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$DiTing_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_diting_dir("platforms/whatsapp/session", "whatsapp/session")

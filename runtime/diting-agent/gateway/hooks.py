...
Hooks are discovered from ~/.diting/hooks/ directories, each containing:
...
HOOKS_DIR = get_diting_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"diting_hook_{hook_name}"

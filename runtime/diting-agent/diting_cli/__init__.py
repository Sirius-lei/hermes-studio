"""
DiTing CLI - Unified command-line interface for DiTing Agent.

Provides subcommands for:
- diting chat          - Interactive chat (same as ./diting)
- diting gateway       - Run gateway in foreground
- diting gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `diting setup` on a fresh Pi.
    ...
    diting_cli/stdio.py::configure_windows_stdio() runs later from the entry

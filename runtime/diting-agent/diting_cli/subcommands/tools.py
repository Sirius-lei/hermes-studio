"""``diting tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'diting tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # diting tools list [--platform cli]
    ...
    # diting tools disable <name...> [--platform cli]
    ...
    # diting tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `diting tools` runs after you pick a provider that\n"

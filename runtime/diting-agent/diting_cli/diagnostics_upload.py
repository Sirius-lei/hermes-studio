"""Client for uploading ``diting debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``diting debug share``.
...
NAS_BASE = os.environ.get(
    "DiTing_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "diting-agent/debug-share"

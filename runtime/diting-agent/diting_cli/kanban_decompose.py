...
Invoked by ``diting kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the DiTing Agent board.
...
def _profile_author() -> str:
    """Mirror of ``diting_cli.kanban._profile_author``."""
    return (

...
Entry point: ``diting whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``diting_cli/main.py``).
...
DiTing gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures DiTing to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  DiTing needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the DiTing gateway in another terminal:")
    print("         diting gateway")
    print()
    ...
    print()
    print("  Docs: https://diting-agent.nousresearch.com/docs/user-guide/")

...
def _has_diting_agent_browser() -> bool:
    ...
    # install.sh installs globally into $DiTing_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-DiTingHome", str(get_diting_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = diting_subprocess_env(inherit_credentials=False)

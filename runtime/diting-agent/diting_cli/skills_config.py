"""
Skills configuration for DiTing Agent.
`diting skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.diting/config.yaml under:
...
from diting_cli.config import cfg_get, load_config, save_config
from diting_cli.colors import Colors, color
from diting_cli.platforms import PLATFORMS as _PLATFORMS

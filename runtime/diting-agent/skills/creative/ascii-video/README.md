...
Built for [DiTing Agent](https://github.com/NousResearch/diting-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/diting-agent/skills/creative/ascii-video`](https://github.com/NousResearch/diting-agent/tree/main/skills/creative/ascii-video) via PR.

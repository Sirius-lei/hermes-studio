...
Data file: $DiTing_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_DiTing_HOME = Path(os.environ.get("DiTing_HOME", Path.home() / ".diting"))
DATA_DIR = _DiTing_HOME / "skills" / "productivity" / "memento-flashcards" / "data"

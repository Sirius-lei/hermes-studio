# Streaming LLM Response Support for DiTing Agent
...
```
DiTing_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("DiTing_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `diting_cli/config.py` | 1 | +streaming config defaults |

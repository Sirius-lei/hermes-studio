...
Config: ~/.diting/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.diting/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_diting_home()`` helper (DiTing_HOME-aware and
...
RULES_FILE = get_diting_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_diting_home() / "feishu_comment_pairing.json"

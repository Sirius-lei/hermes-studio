...
required — uses aiohttp which is already a DiTing dependency.
...
def interactive_setup() -> None:
    ...
    ``diting_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where DiTing delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # diting_cli/setup.py::_setup_mattermost function.

...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> DiTing gateway adapter.

    Each inbound phone number gets its own DiTing session (multi-tenant).
...
# static dict in diting_cli/gateway.py, and the _send_sms dispatch in

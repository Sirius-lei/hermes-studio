...
# When the user hasn't picked a reasoning effort, DiTing passes
...
# ON at this effort — matching the "medium (default)" that DiTing' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map DiTing' effort vocabulary onto Solar's accepted set. xhigh/max/

# DiTing Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.diting/plugins/diting-achievements/state.json` (existing unlock state)
  - `~/.diting/plugins/diting-achievements/scan_snapshot.json` (new)
  - `~/.diting/plugins/diting-achievements/scan_checkpoint.json` (new)

# DiTing Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.diting/plugins/diting-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.diting/plugins/diting-achievements/scan_checkpoint.json`.

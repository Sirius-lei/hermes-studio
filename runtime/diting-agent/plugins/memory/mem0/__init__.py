...
Configuration
-------------
Secret (lives in $DiTing_HOME/.env or the environment):
...
Behavioral settings (live in $DiTing_HOME/mem0.json, set via `diting memory
setup`):
  ...
  agent_id           — Agent identifier (default: diting)
...
def _load_config() -> dict:
    """Load config from env vars, with $DiTing_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "diting"),
        "oss": {},
    }
    ...
    config_path = get_diting_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, diting_home):
        """Write config to $DiTing_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $DiTing_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "diting")

#!/usr/bin/env python3
"""
SWE Runner with DiTing Trajectory Format

A runner that uses DiTing-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the DiTing-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses DiTing-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in DiTing format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches DiTing-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using DiTing-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with DiTing Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses DiTing-Agent's built-in execution environments
    and outputs trajectories in DiTing-Agent format.
    """
    ...
    def _convert_to_diting_format(
        ...
        """
        Convert internal message format to DiTing trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to DiTing trajectory format
        trajectory = self._convert_to_diting_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with DiTing trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with DiTing Trajectory Format")
    print("=" * 60)

# nix/web.nix — DiTing Web Dashboard (Vite/React) frontend build
{ pkgs, ditingNpmLib, ... }:
let
  npm = ditingNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "diting-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../diting_cli/web_dist for the

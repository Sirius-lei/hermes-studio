...
```bash
python3 -m pyfiglet "DiTing" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=DiTing&font=Slant" | boxes -d stone
```

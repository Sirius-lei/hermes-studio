...
| | |
|---|---|
| Source | Optional — install with `diting skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), DiTing Agent |
| License | MIT |
...
Helper script path: `~/.diting/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.diting/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.diting/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.diting/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```

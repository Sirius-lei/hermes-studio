...
| | |
|---|---|
| Source | Optional — install with `diting skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), DiTing Agent |
| License | MIT |
...
The script reads `${DiTing_HOME:-~/.diting}/.env` for two optional defaults:
...
Helper script: `~/.diting/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.diting/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${DiTing_HOME:-~/.diting}/.env`.
...
```bash
python3 ~/.diting/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.diting/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \

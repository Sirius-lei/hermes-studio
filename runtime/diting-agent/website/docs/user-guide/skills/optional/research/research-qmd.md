...
| | |
|---|---|
| Source | Optional — install with `diting skills install official/research/qmd` |
...
DiTing Agent via the native MCP client. This is the preferred
...
Then configure DiTing Agent to connect via HTTP:

...
| | |
|---|---|
| Source | Optional — install with `diting skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | DiTing Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $DiTing_OSINT_CACHE/icij/ (default: ~/.cache/diting-osint/icij/).
...
# Set DiTing_OSINT_UA=your-app/1.0 (your@email) to identify yourself

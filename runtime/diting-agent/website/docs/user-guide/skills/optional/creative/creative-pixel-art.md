...
| | |
|---|---|
| Source | Optional — install with `diting skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.diting/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.diting/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — DiTing installs package this)

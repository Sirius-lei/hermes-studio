...
| | |
|---|---|
| Source | Optional — install with `diting skills install official/health/neuroskill-bci` |
...
Connect DiTing to a running [NeuroSkill](https://neuroskill.com/) instance to read

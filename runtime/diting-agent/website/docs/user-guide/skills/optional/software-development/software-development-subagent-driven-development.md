...
| | |
|---|---|
| Source | Optional — install with `diting skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | DiTing Agent (adapted from obra/superpowers) |
| License | MIT |

...
| | |
|---|---|
| Source | Optional — install with `diting skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), DiTing Agent |
| License | MIT |
...
```
SCRIPT=~/.diting/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.diting/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```

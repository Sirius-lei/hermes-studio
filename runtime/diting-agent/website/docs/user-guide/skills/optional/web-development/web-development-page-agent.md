...
- User wants **DiTing itself to drive a browser** → use DiTing' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.

...
const config: Config = {
  ...
  url: 'https://diting-agent.nousresearch.com',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'diting-agent',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-diting-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NousResearch/diting-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/diting-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://diting-agent.nousresearch.com/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/NousResearch/diting-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/NousResearch/diting-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://diting-agent.nousresearch.com/' },
            { label: 'GitHub', href: 'https://github.com/NousResearch/diting-agent' },

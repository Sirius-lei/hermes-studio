#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the DiTing docs site.
...
Both publish at:
  https://diting-agent.nousresearch.com/docs/llms.txt
  https://diting-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://diting-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use DiTing as a Python Library", None),
        ("guides/use-mcp-with-diting", "Use MCP with DiTing", None),
        ("guides/use-voice-mode-with-diting", "Use Voice Mode with DiTing", None),
        ("guides/use-soul-with-diting", "Use SOUL.md with DiTing", None),
        ("guides/build-a-diting-plugin", "Build a DiTing Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with DiTing"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "diting-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/diting-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# DiTing Agent — Full Documentation\n",
        (
            "This file is the entire DiTing Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using DiTing, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://diting-agent.nousresearch.com/docs\n",
        "Short index: https://diting-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]

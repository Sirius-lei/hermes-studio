...
DEFAULT_DATASETS = [
    ...
    "NousResearch/diting-agent-megascience-sft1",
    "NousResearch/DiTing-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/DiTing-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-diting-agent"
]

#!/usr/bin/env python3
"""Build the DiTing Model Catalog — a centralized JSON manifest of curated models.
...
DiTing CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a DiTing release.
...
# Ensure DiTing_HOME is set for imports that touch it at module level.
os.environ.setdefault("DiTing_HOME", os.path.join(os.path.expanduser("~"), ".diting"))

from diting_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "diting-agent repo",
            "docs": "https://diting-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {

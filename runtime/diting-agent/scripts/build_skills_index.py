#!/usr/bin/env python3
"""Build the DiTing Skills Index — a centralized JSON catalog of all skills.
...
`diting skills search/install` can use it without hitting the GitHub API.
...
# Ensure DiTing_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building DiTing Skills Index...", flush=True)

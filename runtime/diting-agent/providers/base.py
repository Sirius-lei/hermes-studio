...
def _profile_user_agent() -> str:
    """Return a ``diting-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from diting_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"diting-cli/{_ver}"
    except Exception:
        return "diting-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # diting-cli UA so the catalog endpoint is reachable.

 ...
 *
 * Symptom: in `diting --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@diting/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using diting --tui and as i type multiline my caret at the end will often ' +

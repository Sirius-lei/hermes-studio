import { Box, type ScrollBoxHandle, stringWidth, Text } from '@diting/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (DiTing_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (DiTing_DEV_CREDITS), lowest priority,

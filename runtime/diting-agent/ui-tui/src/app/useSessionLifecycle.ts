...
import type { ScrollBoxHandle } from '@diting/ink'
import { evictInkCaches } from '@diting/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.DiTing_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }

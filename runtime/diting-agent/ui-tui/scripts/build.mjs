...
await build({
  ...
  // Skip the prebuilt @diting/ink bundle and inline the source instead:
  ...
  alias: { '@diting/ink': resolve(root, 'packages/diting-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The diting_cli launcher

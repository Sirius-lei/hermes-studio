...
const chartSrc = computed(() => {
  return 'https://api.star-history.com/svg?repos=EKKOLearnAI%2FDiTing-studio&type=Date'
})

onMounted(async () => {
  try {
    const res = await fetch('https://api.github.com/repos/EKKOLearnAI/DiTing-studio')
...
<template>
  <div class="star-panel">
    ...
    <div class="star-chart reveal reveal-delay-2">
      <a
        href="https://www.star-history.com/?type=date&repos=EKKOLearnAI%2FDiTing-studio"
        target="_blank"

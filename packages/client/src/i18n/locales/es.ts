export default {
  ...
  sidebar: {
    ...
    connected: 'Conectado',
    disconnected: 'Desconectado',
    updateTip: 'Ejecuta "diting-web-ui update" en la terminal para actualizar',
  ...
  runtimeVersions: {
    ...
    deleteRuntimeConfirm: '¿Eliminar DiTing Runtime {version}?',
    ...
    activateSuccess: 'Selección de versión guardada. Reinicia DiTing Studio para usarla.',
    jobStatus: {
      queued: 'En cola',
  ...
  chat: {
    ...
    contextEditHint: 'Valores comunes: 256k (DiTing predeterminado), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Inicia una conversacion con el agente principal',
    ...
    DiTingHistory: 'Historial de DiTing',
    historyScopeHint: 'Sesiones del historial de DiTing del perfil actual, de solo lectura y agrupadas por origen.',
    ...
    searchScope: 'Alcance de búsqueda: solo base de datos local de sesiones de Web UI; no incluye sesiones históricas DiTing de solo lectura.',
    ...
    sessionCreateFailed: 'No se pudo crear el espacio de la sesión',
...
jobTriggered: 'Job ejecutado',
  ...
  skills: {
    ...
    writeApprovalDescription: 'Aprueba o rechaza escrituras de memoria y skills preparadas por DiTing Agent.',
    writeApprovalRefresh: 'Actualizar',
    writeApprovalEmpty: 'No hay escrituras pendientes.',
    writeApprovalUnsupported: 'Esta version de DiTing Agent no admite revision de escrituras. Actualiza DiTing Agent para usar esta funcion.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualizar',
    notice: 'Inventario de solo lectura de manifests de plugins DiTing detectables. Los metadatos de descubrimiento se leen sin cargar código de plugins. En v1, la gestión permanece en CLI; los cambios se aplican en nuevas sesiones DiTing.',
  ...
  models: {
    ...
    copilotAddDetected: 'Se detectó un token OAuth de GitHub Copilot en este equipo. Haz clic en Agregar para habilitar Copilot en DiTing.',
    copilotAddSourceEnv: 'Origen: ~/.diting/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Origen: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Origen: extensión Copilot de VS Code (apps.json)',
    copilotDeleteHintEnv: 'Esto borrará COPILOT_GITHUB_TOKEN en ~/.diting/.env. Otras herramientas no se verán afectadas.',
    copilotDeleteHintGhCli: 'Copilot se ocultará de DiTing. Tu sesión de gh CLI no se verá afectada — `gh auth status` seguirá mostrando que estás conectado.',
    copilotDeleteHintAppsJson: 'Copilot se ocultará de DiTing. La extensión Copilot de VS Code seguirá conectada.',
    ...
    visibilityHint: 'Solo afecta al selector de modelos y a la página de modelos de Web UI. No modifica la configuración provider/model de DiTing CLI; las llamadas siguen usando el ID original del modelo.',
    ...
    aliasHint: 'Solo cambia el nombre visible en Web UI. DiTing sigue recibiendo el ID original del modelo.',
    aliasEdit: 'Renombrar',
  ...
  profiles: {
    ...
    rename: 'Renombrar',
    delete: 'Eliminar',
    switchTo: 'Cambiar DiTing Profile',
    switchConfirm: 'Esto ejecutara `DiTing profile use {name}` y cambiara el active profile de DiTing CLI. Continuar?',
    switchSuccess: 'DiTing active profile cambiado a "{name}"',
    switchFailed: 'Error al cambiar DiTing Profile. Es posible que la pasarela necesite un reinicio manual.',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Controla qué gateways de perfiles DiTing locales inicia la Web UI al arrancar. Se guarda en la configuración de la Web UI, no en el config.yaml del perfil.',
      ...
      managementHint: 'Requiere DiTing Agent 0.17.0 o posterior. Al activarlo, Web UI escribe multiplex_profiles para que el gateway default sirva todos los perfiles; otros perfiles no pueden configurar entradas de mensajeria separadas como Feishu, Weixin o QQBot. Al desactivarlo elimina esa configuración.',
    ...
    session: {
      ...
      memoryWriteApprovalHint: 'Preparar las escrituras de memoria de DiTing Agent para aprobacion antes de guardarlas.',
      skillsWriteApproval: 'Revisar escrituras de skills',
      skillsWriteApprovalHint: 'Preparar los cambios de skills de DiTing Agent para aprobacion antes de guardarlos.',
      writeApprovalTitle: 'Escrituras pendientes de revision',
      writeApprovalDescription: 'Aprueba o rechaza escrituras de memoria y skills preparadas por DiTing Agent.',
      writeApprovalRefresh: 'Actualizar',
      writeApprovalEmpty: 'No hay escrituras pendientes.',
  ...
  githubPreview: {
    ...
    stop: "Detener",
    note: "El código de vista previa se guarda bajo el directorio de datos de Web UI. Producción usa el puerto 18648; la vista previa usa frontend 18651 y backend 18647.",
  ...
  codingAgents: {
    ...
    codexDescription: "CLI de OpenAI y flujo del proveedor openai-codex de DiTing para tareas de repositorio.",
    copyCommand: "Copiar",
    commandCopied: "Comando copiado",
    ...
    installFailedDiTingHint: "La instalación falló. Pide a DiTing que lo instale por ti.",
    ...
    notes: {
      ...
      codexAuth: "Agrega credenciales OAuth de OpenAI Codex gestionadas por DiTing.",
  ...
  platform: {
    ...
    weixinTokenHint: 'Desde el inicio de sesion QR de la CLI de weixin (DiTing weixin)',
  ...
  skillsUsage: {
    ...
    subtitle: 'Sigue las cargas y ediciones de habilidades en sesiones de DiTing',
    refresh: 'Actualizar',
  ...
  changelog: {
    ...
    new_0_6_18_2: 'DiTing Studio MCP se divide en toolsets api, devices y use, con nuevas acciones de sesion, modelos, chat-run y ops',
    ...
    new_0_6_18_6: 'La configuracion de desktop y runtime es mas segura con registro Unicode-safe del PATH en Windows, soporte para publicar runtime DiTing Agent 0.17.0, metadata PWA movil y varias correcciones de recuperacion de profile/auth',
    ...
    new_0_6_13_5: 'Las actualizaciones de escritorio son mas fiables: las actualizaciones de Windows cierran procesos DiTing Studio residuales, revisan Cloudflare primero y mantienen GitHub como feed de respaldo',

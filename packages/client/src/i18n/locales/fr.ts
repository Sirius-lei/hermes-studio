export default {
  ...
  sidebar: {
    ...
    connected: 'Connecte',
    disconnected: 'Deconnecte',
    updateTip: 'Executez "diting-web-ui update" dans le terminal pour mettre a jour',
  ...
  runtimeVersions: {
    ...
    deleteRuntimeConfirm: 'Supprimer DiTing Runtime {version} ?',
    ...
    activateSuccess: 'Sélection de version enregistrée. Redémarrez DiTing Studio pour l’utiliser.',
    jobStatus: {
      queued: 'En attente',
      running: 'En cours',
      completed: 'Terminé',
  ...
  chat: {
    ...
    contextEditHint: 'Valeurs courantes : 256k (DiTing par défaut), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Demarrer une conversation avec l agent principal',
    ...
    DiTingHistory: 'Historique DiTing',
    historyScopeHint: 'Sessions d’historique DiTing du profil actuel en lecture seule, regroupées par source.',
    ...
    searchScope: 'Portée de recherche : base locale des sessions Web UI uniquement ; les sessions d’historique DiTing en lecture seule ne sont pas incluses.',
    ...
    sessionCreateFailed: 'Échec de la création de l’espace de session',
...
jobTriggered: 'Job declenche',
  ...
  skills: {
    ...
    writeApprovalDescription: 'Approuvez ou refusez les ecritures de memoire et de skills preparees par DiTing Agent.',
    writeApprovalRefresh: 'Actualiser',
    writeApprovalEmpty: 'Aucune ecriture en attente.',
    writeApprovalUnsupported: 'Cette version de DiTing Agent ne prend pas en charge la validation des ecritures. Mettez DiTing Agent a jour pour utiliser cette fonction.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualiser',
    notice: 'Inventaire en lecture seule des manifests de plugins DiTing détectables. Les métadonnées de découverte sont lues sans charger le code des plugins. En v1, la gestion reste dans le CLI; les changements prennent effet dans les nouvelles sessions DiTing.',
  ...
  models: {
    ...
    copilotAddDetected: 'Un token OAuth GitHub Copilot a été détecté sur cette machine. Cliquez sur Ajouter pour activer Copilot dans DiTing.',
    copilotAddSourceEnv: 'Source : ~/.diting/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Source : gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Source : extension Copilot de VS Code (apps.json)',
    copilotDeleteHintEnv: 'Cela supprimera COPILOT_GITHUB_TOKEN dans ~/.diting/.env. Les autres outils ne sont pas affectés.',
    copilotDeleteHintGhCli: 'Copilot sera masqué dans DiTing. Votre connexion gh CLI n\'est pas affectée — `gh auth status` indiquera toujours que vous êtes connecté.',
    copilotDeleteHintAppsJson: 'Copilot sera masqué dans DiTing. Votre extension Copilot de VS Code reste connectée.',
    ...
    visibilityHint: 'Affecte uniquement le sélecteur de modèles et la page Modèles de la Web UI. La configuration provider/model de DiTing CLI n’est pas modifiée ; les appels utilisent toujours l’ID de modèle d’origine.',
    ...
    aliasHint: 'Modifie uniquement le nom affiché dans la Web UI. DiTing reçoit toujours l’ID de modèle d’origine.',
    aliasEdit: 'Renommer',
  ...
  profiles: {
    ...
    rename: 'Renommer',
    delete: 'Supprimer',
    switchTo: 'Changer DiTing Profile',
    switchConfirm: 'Cette action execute `DiTing profile use {name}` et change le active profile DiTing CLI. Continuer ?',
    switchSuccess: 'DiTing active profile change vers "{name}"',
    switchFailed: 'Echec du changement DiTing Profile. La passerelle peut necessiter un redemarrage manuel.',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Contrôle les gateways de profils DiTing locaux que la Web UI démarre au lancement. Cette option est stockée dans la configuration Web UI, pas dans le config.yaml du profil.',
    ...
    session: {
      ...
      memoryWriteApprovalHint: 'Mettre les ecritures de memoire de DiTing Agent en attente de validation avant de les enregistrer.',
      skillsWriteApproval: 'Verifier les ecritures de skills',
      skillsWriteApprovalHint: 'Mettre les modifications de skills de DiTing Agent en attente de validation avant de les enregistrer.',
      writeApprovalTitle: 'Ecritures en attente de validation',
      writeApprovalDescription: 'Approuvez ou refusez les ecritures de memoire et de skills preparees par DiTing Agent.',
      writeApprovalRefresh: 'Actualiser',
      writeApprovalEmpty: 'Aucune ecriture en attente.',
  ...
  githubPreview: {
    ...
    stop: "Arrêter",
    note: "Le code de prévisualisation est stocké dans le dossier de données Web UI. La production utilise le port 18648 ; la prévisualisation utilise le frontend 18651 et le backend 18647.",
  ...
  codingAgents: {
    ...
    codexDescription: "CLI OpenAI et flux fournisseur DiTing openai-codex pour les tâches de dépôt.",
    copyCommand: "Copier",
    commandCopied: "Commande copiée",
    ...
    installFailedDiTingHint: "L’installation a échoué. Demandez à DiTing de l’installer pour vous.",
    ...
    notes: {
      ...
      codexAuth: "Ajoute les identifiants OAuth OpenAI Codex gérés par DiTing.",
  ...
  platform: {
    ...
    weixinTokenHint: 'Depuis la connexion QR de la CLI weixin (DiTing weixin)',
  ...
  skillsUsage: {
    ...
    subtitle: 'Suivre les chargements et modifications de compétences dans les sessions DiTing',
    refresh: 'Actualiser',
  ...
  changelog: {
    ...
    new_0_6_18_2: 'DiTing Studio MCP est separe en toolsets api, devices et use, avec de nouvelles actions session, model, chat-run et ops',
    ...
    new_0_6_18_6: 'La configuration desktop et runtime est plus sure avec un enregistrement PATH Windows compatible Unicode, le support de publication runtime DiTing Agent 0.17.0, les metadonnees PWA mobile et plusieurs corrections profile/auth',
    ...
    new_0_6_13_5: 'Les mises a jour desktop sont plus fiables : les mises a niveau Windows ferment les anciens processus DiTing Studio, Cloudflare est verifie en premier et GitHub reste le flux de secours',

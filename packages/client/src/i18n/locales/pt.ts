export default {
  ...
  sidebar: {
    ...
    connected: 'Conectado',
    disconnected: 'Desconectado',
    updateTip: 'Execute "diting-web-ui update" no terminal para atualizar',
  ...
  runtimeVersions: {
    ...
    deleteRuntimeConfirm: 'Excluir DiTing Runtime {version}?',
    ...
    activateSuccess: 'Seleção de versão salva. Reinicie o DiTing Studio para usá-la.',
    jobStatus: {
      queued: 'Na fila',
      running: 'Em execução',
      completed: 'Concluída',
  ...
  chat: {
    ...
    contextEditHint: 'Valores comuns: 256k (DiTing padrão), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    DiTingHistory: 'Histórico DiTing',
    historyScopeHint: 'Sessões do histórico DiTing do perfil atual, somente leitura, agrupadas por origem.',
    ...
    searchScope: 'Escopo da busca: apenas banco local de sessões da Web UI; sessões históricas DiTing somente leitura não são incluídas.',
...
jobTriggered: 'Job acionado',
  ...
  skills: {
    ...
    writeApprovalDescription: 'Aprove ou rejeite escritas de memoria e skills preparadas pelo DiTing Agent.',
    writeApprovalRefresh: 'Atualizar',
    writeApprovalEmpty: 'Nenhuma escrita pendente.',
    writeApprovalUnsupported: 'Esta versao do DiTing Agent nao suporta revisao de escritas. Atualize o DiTing Agent para usar este recurso.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Atualizar',
    notice: 'Inventário somente leitura dos manifests de plugins DiTing detectáveis. Os metadados de descoberta são lidos sem carregar código de plugin. No v1, ações de gerenciamento ficam na CLI; mudanças entram em vigor em novas sessões DiTing.',
  ...
  models: {
    ...
    copilotAddDetected: 'Foi detectado um token OAuth do GitHub Copilot nesta máquina. Clique em Adicionar para ativar o Copilot no DiTing.',
    copilotAddSourceEnv: 'Origem: ~/.diting/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Origem: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Origem: extensão Copilot do VS Code (apps.json)',
    copilotDeleteHintEnv: 'Isto irá limpar o COPILOT_GITHUB_TOKEN em ~/.diting/.env. Outras ferramentas não são afetadas.',
    copilotDeleteHintGhCli: 'O Copilot ficará oculto no DiTing. Sua sessão no gh CLI não é afetada — `gh auth status` continuará indicando que está conectado.',
    copilotDeleteHintAppsJson: 'O Copilot ficará oculto no DiTing. A extensão Copilot do VS Code continuará conectada.',
    ...
    visibilityHint: 'Afeta apenas o seletor de modelos e a página de modelos da Web UI. A configuração provider/model da DiTing CLI não é alterada; as chamadas ainda usam o ID original do modelo.',
    ...
    aliasHint: 'Altera apenas o nome exibido na Web UI. O DiTing ainda recebe o ID original do modelo.',
    aliasEdit: 'Renomear',
  ...
  profiles: {
    ...
    rename: 'Renomear',
    delete: 'Excluir',
    switchTo: 'Trocar DiTing Profile',
    switchConfirm: 'Isto executara `DiTing profile use {name}` e alterara o active profile do DiTing CLI. Continuar?',
    switchSuccess: 'DiTing active profile alterado para "{name}"',
    switchFailed: 'Falha ao trocar DiTing Profile. O gateway pode precisar de reinicio manual.',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Controla quais gateways de perfis DiTing locais a Web UI inicia durante a inicialização. Isto é salvo na configuração da Web UI, não no config.yaml do perfil.',
      ...
      managementHint: 'Requer DiTing Agent 0.17.0 ou superior. Quando ativado, a Web UI grava multiplex_profiles para o gateway default servir todos os perfis; outros perfis nao podem configurar entradas de mensagens separadas como Feishu, Weixin ou QQBot. Ao desativar, remove essa configuração.',
    ...
    session: {
      ...
      memoryWriteApprovalHint: 'Colocar escritas de memoria do DiTing Agent em aprovacao antes de salvar.',
      skillsWriteApproval: 'Revisar escritas de skills',
      skillsWriteApprovalHint: 'Colocar alteracoes de skills do DiTing Agent em aprovacao antes de salvar.',
      writeApprovalTitle: 'Escritas pendentes de revisao',
      writeApprovalDescription: 'Aprove ou rejeite escritas de memoria e skills preparadas pelo DiTing Agent.',
      writeApprovalRefresh: 'Atualizar',
      writeApprovalEmpty: 'Nenhuma escrita pendente.',
  ...
  githubPreview: {
    ...
    stop: "Parar",
    note: "O código de prévia é armazenado no diretório de dados do Web UI. A produção usa a porta 18648; a prévia usa frontend 18651 e backend 18647.",
  ...
  codingAgents: {
    ...
    codexDescription: "CLI da OpenAI e fluxo de provedor openai-codex do DiTing para tarefas de repositório.",
    copyCommand: "Copiar",
    commandCopied: "Comando copiado",
    ...
    installFailedDiTingHint: "A instalação falhou. Peça ao DiTing para instalar para você.",
    ...
    notes: {
      ...
      codexAuth: "Adiciona credenciais OAuth do OpenAI Codex gerenciadas pelo DiTing.",
  ...
  platform: {
    ...
    weixinTokenHint: 'Do login QR da CLI weixin (DiTing weixin)',
  ...
  skillsUsage: {
    ...
    subtitle: 'Acompanhe carregamentos e edições de habilidades nas sessões DiTing',
    refresh: 'Atualizar',
  ...
  changelog: {
    ...
    new_0_6_18_2: 'DiTing Studio MCP foi dividido em toolsets api, devices e use, com novas acoes de session, model, chat-run e ops',
    ...
    new_0_6_18_6: 'Desktop e runtime setup ficaram mais seguros com registro Unicode-safe do PATH no Windows, suporte a publicar runtime DiTing Agent 0.17.0, metadata PWA movel e varias correcoes de profile/auth recovery',
    ...
    new_0_6_13_5: 'As atualizacoes desktop estao mais confiaveis: upgrades no Windows fecham processos DiTing Studio residuais, verificam Cloudflare primeiro e mantem GitHub como feed de fallback',

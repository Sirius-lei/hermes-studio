export default {
  ...
  sidebar: {
    ...
    connected: 'Verbunden',
    disconnected: 'Getrennt',
    updateTip: 'Fuhren Sie "diting-web-ui update" im Terminal aus, um zu aktualisieren',
  ...
  runtimeVersions: {
    ...
    deleteRuntimeConfirm: 'DiTing Runtime {version} löschen?',
    ...
    activateSuccess: 'Versionsauswahl gespeichert. Starten Sie DiTing Studio neu, um sie zu verwenden.',
    jobStatus: {
  ...
  chat: {
    ...
    contextEditHint: 'Häufige Werte: 256k (DiTing-Standard), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Starten Sie eine Konversation mit dem primaren Agenten',
    ...
    DiTingHistory: 'DiTing-Verlauf',
    historyScopeHint: 'Schreibgeschützte DiTing-Verlaufssitzungen des aktuellen Profils, nach Quelle gruppiert.',
    ...
    searchScope: 'Suchbereich: nur lokale Web-UI-Sitzungsdatenbank; schreibgeschützte DiTing-Verlaufssitzungen sind nicht enthalten.',
    ...
    sessionCreateFailed: 'Sitzungsspeicher konnte nicht erstellt werden',
...
jobTriggered: 'Job ausgelost',
  ...
  skills: {
    ...
    writeApprovalDescription: 'Freigeben oder ablehnen, was DiTing Agent fuer Speicher und Skills vorgemerkt hat.',
    writeApprovalRefresh: 'Aktualisieren',
    writeApprovalEmpty: 'Keine ausstehenden Schreibvorgaenge.',
    writeApprovalUnsupported: 'Diese DiTing-Agent-Version unterstuetzt keine Schreibfreigaben. Aktualisiere DiTing Agent, um diese Funktion zu nutzen.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Aktualisieren',
    notice: 'Schreibgeschütztes Inventar erkennbarer DiTing-Plugin-Manifeste. Discovery-Metadaten werden gelesen, ohne Plugin-Code zu laden. Verwaltungsaktionen bleiben in v1 im CLI; Änderungen gelten für neue DiTing-Sitzungen.',
  ...
  models: {
    ...
    copilotAddDetected: 'Auf diesem Rechner wurde ein GitHub Copilot OAuth-Token erkannt. Klicken Sie auf „Hinzufügen", um Copilot in DiTing zu aktivieren.',
    copilotAddSourceEnv: 'Quelle: ~/.diting/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Quelle: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Quelle: VS Code Copilot-Erweiterung (apps.json)',
    copilotDeleteHintEnv: 'Dies löscht COPILOT_GITHUB_TOKEN in ~/.diting/.env. Andere Tools sind nicht betroffen.',
    copilotDeleteHintGhCli: 'Copilot wird aus DiTing ausgeblendet. Ihre gh CLI-Anmeldung bleibt erhalten — `gh auth status` zeigt weiterhin als angemeldet.',
    copilotDeleteHintAppsJson: 'Copilot wird aus DiTing ausgeblendet. Ihre VS Code Copilot-Erweiterung bleibt angemeldet.',
    ...
    visibilityHint: 'Wirkt sich nur auf Modellauswahl und Modellseite der Web UI aus. Die provider/model-Konfiguration der DiTing CLI wird nicht geändert; Aufrufe verwenden weiterhin die ursprüngliche Modell-ID.',
    ...
    aliasHint: 'Ändert nur den Anzeigenamen in der Web UI. DiTing erhält weiterhin die ursprüngliche Modell-ID.',
  ...
  profiles: {
    ...
    rename: 'Umbenennen',
    delete: 'Loschen',
    switchTo: 'DiTing Profile wechseln',
    switchConfirm: 'Dies fuehrt `DiTing profile use {name}` aus und aendert das aktive DiTing CLI Profile. Fortfahren?',
    switchSuccess: 'Aktives DiTing Profile ist jetzt "{name}"',
    switchFailed: 'DiTing Profile konnte nicht gewechselt werden. Das Gateway muss eventuell manuell neu gestartet werden.',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Legt fest, welche lokalen DiTing-Profile-Gateways die Web UI beim Start startet. Diese Einstellung wird in der Web-UI-Konfiguration gespeichert, nicht in der profile config.yaml.',
    ...
    session: {
      ...
      memoryWriteApprovalHint: 'DiTing-Agent-Speicherschreibungen vor dem Speichern zur Freigabe vormerken.',
      skillsWriteApproval: 'Skill-Schreibungen pruefen',
      skillsWriteApprovalHint: 'DiTing-Agent-Skill-Aenderungen vor dem Speichern zur Freigabe vormerken.',
      writeApprovalTitle: 'Ausstehende Schreibfreigaben',
      writeApprovalDescription: 'Freigeben oder ablehnen, was DiTing Agent fuer Speicher und Skills vorgemerkt hat.',
      writeApprovalRefresh: 'Aktualisieren',
      writeApprovalEmpty: 'Keine ausstehenden Schreibvorgaenge.',
  ...
  githubPreview: {
    ...
    stop: "Stoppen",
    note: "Der Vorschaucode wird im Web-UI-Datenverzeichnis gespeichert. Die Produktion nutzt Port 18648; die Vorschau verwendet Frontend 18651 und Backend 18647.",
    path: "Vorschaupfad",
  ...
  codingAgents: {
    ...
    codexDescription: "OpenAI CLI und DiTing openai-codex Anbieter-Flow fur Repository-Aufgaben.",
    ...
    installFailedDiTingHint: "Installation fehlgeschlagen. Bitte DiTing, es fur dich zu installieren.",
    ...
    notes: {
      ...
      codexAuth: "Fugt DiTing-verwaltete OpenAI Codex OAuth-Zugangsdaten hinzu.",
  ...
  platform: {
    ...
    weixinTokenHint: 'Von Weixin-CLI QR-Anmeldung (DiTing weixin)',
    accountId: 'Konto-ID',
  ...
  skillsUsage: {
    title: 'Skill-Nutzung',
    subtitle: 'Skill-Ladevorgänge und -Bearbeitungen aus DiTing-Sitzungen verfolgen',
    refresh: 'Aktualisieren',
  ...
  changelog: {
    ...
    new_0_6_18_2: 'DiTing Studio MCP ist in fokussierte api-, devices- und use-Toolsets aufgeteilt, mit neuen Session-, Modell-, Chat-Run- und Ops-Aktionen',
    ...
    new_0_6_18_6: 'Desktop- und Runtime-Setup sind sicherer mit Unicode-sicherer Windows-PATH-Registrierung, DiTing Agent 0.17.0 Runtime-Publishing, mobiler PWA-Metadata und mehreren Profile/Auth-Recovery-Fixes',
    ...
    new_0_6_13_5: 'Desktop-Updates sind verlaesslicher: Windows-Upgrades schliessen alte DiTing-Studio-Prozesse, pruefen zuerst Cloudflare und behalten GitHub als Fallback-Feed',

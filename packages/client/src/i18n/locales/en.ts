export default {
  ...
  sidebar: {
    ...
    expand: 'Expand menu',
    updateTip: 'Run "diting-web-ui update" in terminal to update',
  ...
  runtimeVersions: {
    ...
    deleteRuntimeConfirm: 'Delete DiTing Runtime {version}?',
    ...
    activateSuccess: 'Version selection saved. Restart DiTing Studio to use it.',
    jobStatus: {
      queued: 'Queued',
      running: 'Running',
      completed: 'Completed',
  ...
  chat: {
    ...
    contextEditHint: 'Common values: 256k (DiTing default), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Start a conversation with the primary agent',
    ...
    DiTingHistory: 'DiTing History',
    historyScopeHint: 'Read-only DiTing history sessions for the current profile, grouped by source.',
    noSessions: 'No sessions',
    searchTitle: 'Search Sessions',
    searchSubtitle: 'Search by title or message content',
    searchScope: 'Search scope: Web UI local session database only. Read-only DiTing history sessions are not included.',
  ...
  skills: {
    ...
    writeApprovalDescription: 'Approve or reject staged DiTing Agent memory and skill writes.',
    writeApprovalRefresh: 'Refresh',
    writeApprovalEmpty: 'No pending writes.',
    writeApprovalUnsupported: 'This DiTing Agent version does not support write approvals. Upgrade DiTing Agent to use this feature.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Refresh',
    notice: 'Read-only inventory of discoverable DiTing plugin manifests. Discovery metadata is read without loading plugin code. Management actions stay in CLI for v1; changes take effect in new DiTing sessions.',
  ...
  models: {
    ...
    copilotAddDetected: 'A GitHub Copilot OAuth token was detected on this machine. Click Add to enable Copilot in DiTing.',
    ...
    copilotDeleteHintEnv: 'This will clear COPILOT_GITHUB_TOKEN in ~/.diting/.env. Other tools are not affected.',
    copilotDeleteHintGhCli: 'Copilot will be hidden from DiTing. Your gh CLI login is not affected — `gh auth status` will still show you signed in.',
    copilotDeleteHintAppsJson: 'Copilot will be hidden from DiTing. Your VS Code Copilot extension login is not affected.',
    ...
    aliasHint: 'Display-only alias. DiTing still receives the canonical model ID.',
    ...
    visibilityHint: 'Only affects the Web UI model picker and Models page. DiTing CLI provider/model config is not rewritten; calls still use canonical model IDs.',
  ...
  profiles: {
    ...
    rename: 'Rename',
    delete: 'Delete',
    switchTo: 'Switch DiTing Profile',
    switchConfirm: 'This will run `DiTing profile use {name}` and change the active DiTing CLI profile. Continue?',
    switchSuccess: 'DiTing active profile switched to "{name}"',
    switchFailed: 'Failed to switch DiTing profile. Gateway may need manual restart.',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Control which local DiTing profile gateways the Web UI starts during startup. This is stored in the Web UI config, not a profile config.yaml.',
      ...
      managementHint: 'Requires DiTing Agent 0.17.0 or later. When enabled, Web UI writes multiplex_profiles so the default gateway serves every profile; other profiles cannot configure separate Feishu, Weixin, QQBot, or similar messaging entrypoints. Turning it off removes that config.',
      managementAuto: 'Auto',
    ...
    session: {
      ...
      memoryWriteApprovalHint: 'Stage DiTing Agent memory writes for approval before they are saved.',
      skillsWriteApproval: 'Review skill writes',
      skillsWriteApprovalHint: 'Stage DiTing Agent skill changes for approval before they are saved.',
      writeApprovalTitle: 'Pending write approvals',
      writeApprovalDescription: 'Approve or reject staged DiTing Agent memory and skill writes.',
      writeApprovalRefresh: 'Refresh',
      writeApprovalEmpty: 'No pending writes.',
  ...
  githubPreview: {
    ...
    start: "Start Preview",
    stop: "Stop",
    note: "Preview code is stored under the Web UI data home. Production runs on port 18648; preview development runs on frontend 18651 and backend 18647.",
    path: "Preview Path",
  ...
  codingAgents: {
    ...
    codexDescription: "OpenAI CLI and DiTing openai-codex provider flow for repository tasks.",
    copyCommand: "Copy",
    commandCopied: "Command copied",
    ...
    installFailedDiTingHint: "Installation failed. Ask DiTing to install it for you.",
    ...
    notes: {
      ...
      codexAuth: "Adds DiTing-managed OpenAI Codex OAuth credentials.",
  ...
  platform: {
    ...
    weixinTokenHint: 'From weixin CLI QR login (DiTing weixin)',
  ...
  skillsUsage: {
    title: 'Skills Usage',
    subtitle: 'Track skill loads and edits from DiTing sessions',
    refresh: 'Refresh',
  ...
  changelog: {
    ...
    new_0_6_18_2: 'DiTing Studio MCP is split into focused api, devices, and use toolsets with new session, model, chat-run, and ops actions',
    ...
    new_0_6_18_6: 'Desktop and runtime setup are safer with Unicode-safe Windows PATH registration, DiTing Agent 0.17.0 runtime publishing support, mobile PWA metadata, and several profile/auth recovery fixes',
    ...
    new_0_6_13_5: 'Desktop updates are more reliable: Windows upgrades close stale DiTing Studio processes, Cloudflare is checked first, and GitHub remains the fallback feed',

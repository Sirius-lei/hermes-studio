...
import { useJobsStore } from '@/stores/DiTing/jobs'
...
} from '@/api/DiTing/jobs'
import type { CreateJobRequest, Job } from '@/api/DiTing/jobs'
import { fetchSkills } from '@/api/DiTing/skills'
import type { SkillInfo } from '@/api/DiTing/skills'

...
const PIN_KEY_PREFIX = 'DiTing_session_pins_v1_'
const HUMAN_ONLY_KEY_PREFIX = 'DiTing_human_only_v1_'
...
function currentProfileName(): string {
  try {
    ...
    return localStorage.getItem('DiTing_active_profile_name') || 'default'
  }
}

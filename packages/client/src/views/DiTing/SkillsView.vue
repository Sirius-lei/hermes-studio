...
import SkillDetail from '@/components/DiTing/skills/SkillDetail.vue'
import SkillImportModal from '@/components/DiTing/skills/SkillImportModal.vue'
import SkillExternalDirsModal from '@/components/DiTing/skills/SkillExternalDirsModal.vue'
import PendingWriteApprovals from '@/components/DiTing/skills/PendingWriteApprovals.vue'
import { fetchSkills, type SkillCategory, type SkillSource, type SkillInfo, type SkillTarget } from '@/api/DiTing/skills'
import { fetchPendingWrites } from '@/api/DiTing/write-gate'
...
const skillTarget = ref<SkillTarget>('DiTing')
...
const skillTargetOptions = computed(() => [
  { label: t('skills.targets.DiTing'), value: 'DiTing' },
  { label: t('skills.targets.claude'), value: 'claude' },
  { label: t('skills.targets.codex'), value: 'codex' },
])

const isDiTingTarget = computed(() => skillTarget.value === 'DiTing')
...
function handleTargetChange() {
  ...
  loadSkills()
  if (skillTarget.value === 'DiTing') loadPendingWriteCount()
}
  ...
  <div class="skills-view">
    <header class="page-header">
      ...
      <div class="header-actions">
        <NButton
          v-if="isDiTingTarget && writeApprovalSupported"

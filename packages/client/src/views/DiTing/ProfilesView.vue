...
import ProfilesPanel from '@/components/DiTing/profiles/ProfilesPanel.vue'
import ProfileCreateModal from '@/components/DiTing/profiles/ProfileCreateModal.vue'
import ProfileRenameModal from '@/components/DiTing/profiles/ProfileRenameModal.vue'
import ProfileImportModal from '@/components/DiTing/profiles/ProfileImportModal.vue'
...
onMounted(() => {
  profilesStore.fetchDiTingProfiles()
})

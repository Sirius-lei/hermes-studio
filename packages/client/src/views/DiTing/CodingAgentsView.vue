...
import { fetchAvailableModelsForProfile, type AvailableModelGroup } from '@/api/DiTing/system'
import { useProfilesStore } from '@/stores/DiTing/profiles'
import TerminalPanel from '@/components/DiTing/chat/TerminalPanel.vue'
...
async function handleInstall(id: CodingAgentId) {
  ...
  try {
    ...
    if (result.success) {
      ...
      installFailureHints.value[id] = t('codingAgents.installFailedDiTingHint')

...
sessionRoutes.get('/api/hermes/sessions/:id/collaboration-runs', ctrl.listCollaborationRuns)
sessionRoutes.get('/api/hermes/sessions/:id/context', ctrl.getContext)
sessionRoutes.get('/api/hermes/collaboration-runs/:id', ctrl.getCollaborationRun)
sessionRoutes.get('/api/hermes/collaboration-runs/:id/events', ctrl.getCollaborationRunEvents)

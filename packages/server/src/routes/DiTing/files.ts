...
// GET /api/DiTing/files/list?path=
fileRoutes.get('/api/DiTing/files/list', async (ctx) => {
...
// GET /api/DiTing/files/stat?path=
fileRoutes.get('/api/DiTing/files/stat', async (ctx) => {
  const relativePath = ctx.query.path as string
  if (!relativePath) {
    ctx.status = 400
...
// GET /api/DiTing/files/read?path=
fileRoutes.get('/api/DiTing/files/read', requireSuperAdmin, async (ctx) => {
  const relativePath = ctx.query.path as string
  if (!relativePath) {
    ctx.status = 400
    ctx.body = { error: 'Missing path parameter', code: 'missing_path' }
...
// PUT /api/DiTing/files/write  body: { path, content }
fileRoutes.put('/api/DiTing/files/write', requireSuperAdmin, async (ctx) => {
...
// DELETE /api/DiTing/files/delete  body: { path, recursive? }
fileRoutes.delete('/api/DiTing/files/delete', requireSuperAdmin, async (ctx) => {
...
// POST /api/DiTing/files/rename  body: { oldPath, newPath }
fileRoutes.post('/api/DiTing/files/rename', requireSuperAdmin, async (ctx) => {
...
// POST /api/DiTing/files/mkdir  body: { path }
fileRoutes.post('/api/DiTing/files/mkdir', requireSuperAdmin, async (ctx) => {
...
// POST /api/DiTing/files/copy  body: { srcPath, destPath }
fileRoutes.post('/api/DiTing/files/copy', requireSuperAdmin, async (ctx) => {
...
// POST /api/DiTing/files/upload?path=  (multipart/form-data)
fileRoutes.post('/api/DiTing/files/upload', requireSuperAdmin, async (ctx) => {

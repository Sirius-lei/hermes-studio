/**
 * Compatibility layer for the two `config.yaml` provider schemas used by DiTing Agent.
 *
 * DiTing Agent's v12 migration converts `custom_providers:` (a list of provider
 ...
 *
 *   https://github.com/NousResearch/diting-agent/blob/main/diting_cli/config.py
 *
 ...
 * schemas with name/base_url/model deduplication. Mirrors DiTing Agent's

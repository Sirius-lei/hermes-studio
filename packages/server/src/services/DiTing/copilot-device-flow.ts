 ...
 *
 * Mirrors the upstream diting-agent implementation
 * (`diting_cli/copilot_auth.py:155-275`):
 ...
 *
 * Client ID `Ov23li8tweQw6odWQebz` is reused from upstream diting-agent for now;

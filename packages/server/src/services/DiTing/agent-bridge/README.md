...
```bash
DiTing_AGENT_BRIDGE_WORKER_TRANSPORT=tcp DiTing_AGENT_BRIDGE_WORKER_PORT_BASE=28780 python packages/server/src/services/DiTing/agent-bridge/python/DiTing_bridge.py
```

...
class BridgeServer:
    ...
    def __init__(self, endpoint: str) -> None:
        ...
        self._session_idle_timeout_seconds = _positive_int(
            os.environ.get("DiTing_AGENT_BRIDGE_SESSION_IDLE_TIMEOUT_SECONDS")
        ...
        self._disable_session_idle_gc = str(
            os.environ.get("DiTing_AGENT_BRIDGE_DISABLE_SESSION_IDLE_GC", "")
    ...
    def serve_forever(self) -> None:
        ...
        _start_parent_process_watchdog(
            _positive_int(os.environ.get("DiTing_AGENT_BRIDGE_BROKER_PID")),
            self._stop,
        ...
        try:
            ...
            while not self._stop.is_set():
                ...
                try:
                    ...
                    print(f"[DiTing-bridge] server loop error: {exc}", file=sys.stderr, flush=True)
                finally:
                    if conn is not None:
                        try:
                            conn.close()

...
import { startDeviceFlow, pollDeviceFlow } from '../../services/DiTing/copilot-device-flow'
...
} from '../../services/DiTing/copilot-models'
import { getActiveEnvPath } from '../../services/DiTing/DiTing-profile'
...
async function persistToken(token: string): Promise<void> {
  // 与 disable 对称：只动 ~/.diting/.env，apps.json 是 VS Code 的文件不要碰。
 ...
 *   - source='env'        → also clear ~/.diting/.env COPILOT_GITHUB_TOKEN
 *                           (this token belongs to the DiTing ecosystem).

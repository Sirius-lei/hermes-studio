...
import { getCompatibleCustomProviders, normalizeCustomProviderEntry } from '../../services/DiTing/custom-providers-compat'
...
export async function create(ctx: any) {
  ...
  try {
    ...
    // try { await DiTingCli.restartGateway() } catch (e: any) { logger.error(e, 'Gateway restart failed') }

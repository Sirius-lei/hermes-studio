 ...
 * - GATEWAY_PORT: Default DiTing gateway upstream port. Default: 8642.
 ...
 * - DiTing_LAN_DISCOVERY_HTTP_PORTS: HTTP ports to probe during UDP discovery scans. Default: 8648,8748 plus current PORT.
